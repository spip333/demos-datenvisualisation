...
## Lernziel:    Visuelle Auswertungstechniken zur Visualisierung mehrerer Variablen
##              
##
####################################
...
# vgl. auch "Why you should master the small multiples chart":
# https://www.r-bloggers.com/why-you-should-master-the-small-multiple-chart/
